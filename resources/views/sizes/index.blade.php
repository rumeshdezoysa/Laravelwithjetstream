            ...
            <div class="col-lg-10">
              <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('sizes.create') }}" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus"></i></a>
                  </div>
                        ...
                        <table class="table table-bordered datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $size->size ?? '' }}</td>
                                    <td>
                                        <a href="{{ route('sizes.edit',$size->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
